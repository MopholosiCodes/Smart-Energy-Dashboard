                ...
                <div className="container-fluid">
                    <div className="row flex-xl-nowrap">
                        ...
                        <div id="nav" className="col-12 col-md-3 col-xl-2 bd-sidebar">
                            <div className="row">
                                <div className="col-md-12 col-8">
                                    <div className="text-sm-left text-md-center logo">SMART ENERGY<span id="beta"> BETA</span></div>
                                </div>
                        ...
                        <div id="content-body" className="col-12 col-md-9 col-xl-10 pl-4 pr-4 bd-content">
                            ...
                            {/* heading row end time frame row start */}
                            ...
                            {/* time frame row end chart row start */}
